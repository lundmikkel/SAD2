...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        scanDir("test_data/").forEach((s) -> files.add(new Tuple<>(s,"")));
        ...
        List<Tuple<Integer, Float>> result = new Executor(files)
                ...
                .add(new TransformMapper(), new EchoReducer(false))
                .add(new ActorRatingMapper(), new EchoReducer(false), 10)
